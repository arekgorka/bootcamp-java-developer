...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://arekgorka.github.io/";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("arekgorka91@gmail.com");
        driverTrello.findElement(By.id("password")).sendKeys("91gorkaarek");
    ...
    private void shouldDeleteTestTask(String taskName) throws InterruptedException {
        driver.findElements(
                        By.xpath("//form[@class=\"datatable__row\"]")).stream()
                .filter(anyForm ->
                        anyForm.findElement(By.xpath(".//p[@class=\"datatable__field-value\"]"))
